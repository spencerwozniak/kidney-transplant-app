...
const PathwayIcon = ({ size = 24, color = '#6B7280' }: IconProps) => (
...
const ChatIcon = ({ size = 24, color = '#FFFFFF' }: IconProps) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
    ...
    <View className="relative border-t border-gray-200 bg-white">
      <View className="flex-row items-center justify-around pb-4 pt-2">
        ...
        <TouchableOpacity
          ...
          <View className="mb-1">
            <PathwayIcon size={24} color={pathwayColor} />
          </View>
          <Text
        ...
        {/* Chat Button - Prominent Middle Button */}
        <View className="items-center justify-center" style={{ marginTop: -20 }}>
          <TouchableOpacity
            onPress={() => onTabChange('chat')}
            activeOpacity={0.8}
            className="items-center justify-center rounded-full bg-green-600 shadow-lg"
            style={{
              width: 56,
              height: 56,
              shadowColor: '#000',
